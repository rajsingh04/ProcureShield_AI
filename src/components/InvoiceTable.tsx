...
const InvoiceTable: React.FC<InvoiceTableProps> = ({ invoices }) => {
  const [selectedInvoice, setSelectedInvoice] = useState<FlaggedInvoice | null>(
    null,
  );
  ...
  const filteredInvoices = useMemo(() => {
    return invoices.filter((inv) => {
      ...
      const vendor = String(
        inv["Vendor Name Clean"] || inv["Vendor Name"] || "",
      ).toLowerCase();
  ...
  return (
    <>
            ...
            <tbody>
              {filteredInvoices.map((inv, idx) => (
                ...
                >
                  ...
                  <td>
                    {inv["Vendor Name Clean"] || inv["Vendor Name"] || "N/A"}
                  </td>
                  <td>{inv["Total Invoice (Rs.)"] || 0}</td>
                  <td>
                    <span
                      className={`anomaly-badge type_${(inv.PREDICTED_ANOMALY || "").replace(/\s+/g, "_").toLowerCase()}`}
                    >
                  ...
                  <td>
                    <span
                      className={`decision-badge ${inv.risk_decision === "AUTO HOLD" ? "hold" : inv.risk_decision === "MANUAL REVIEW" ? "review" : "approve"}`}
                    >
                      {inv.risk_decision}
                    </span>
                  </td>
      ...
      <div
        className={`detail-overlay ${selectedInvoice ? "show" : ""}`}
        onClick={closePanel}
      >
                  ...
                  <div className="detail-grid">
                    <div className="detail-item">
                      ...
                      <div className="detail-val">
                        {selectedInvoice["Invoice No"] || "N/A"}
                      </div>
                    </div>
                    <div className="detail-item">
                      <div className="detail-lbl">Amount</div>
                      <div className="detail-val" style={{ color: "#f59e0b" }}>
                        ₹ {selectedInvoice["Total Invoice (Rs.)"]}
                      </div>
                    </div>
                    <div className="detail-item">
                      <div className="detail-lbl">Vendor name</div>
                      <div className="detail-val">
                        {selectedInvoice["Vendor Name Clean"] ||
                    ...
                    <div className="detail-item">
                      ...
                      <div className="detail-val">
                        {selectedInvoice["PO Number"] ||
                          selectedInvoice["PO Reference"] ||
                          "N/A"}
                      </div>
                    </div>
                    <div className="detail-item">
                    ...
                    <div className="detail-item">
                      ...
                      <div className="detail-val">
                        {selectedInvoice["GRN Reference"] ||
                          selectedInvoice["GRN No"] ||
                          "N/A"}
                      </div>
                    </div>
                    <div className="detail-item">
                    ...
                    <div className="detail-item">
                      ...
                      <div className="detail-val">
                        {selectedInvoice["Department"] ||
                          selectedInvoice["Dept"] ||
                          selectedInvoice["Cost Center"] ||
                          "N/A"}
                      </div>
                    </div>
                  </div>
                ...
                <div className="panel-section">
                  ...
                  <div className="detail-grid">
                    ...
                    >
                      ...
                      <div className="detail-val">
                        {selectedInvoice.PREDICTED_ANOMALY}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="panel-section">
                    ...
                    >
                      {selectedInvoice.reason ||
                        "This invoice has been flagged by the AI model due to high similarities with historical anomalies or unusual billing patterns."}
                    </p>
                  </div>
                )}
              </>
